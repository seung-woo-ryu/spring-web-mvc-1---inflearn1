...
import hello.servlet.member.MemberRepository; import hello.servlet.web.frontcontroller.MyView;
...
public class MemberListControllerV2 implements ControllerV2 {
    ...
    public MyView process(HttpServletRequest request, HttpServletResponse
            response) throws ServletException, IOException { List<Member> members = memberRepository.findAll(); request.setAttribute("members", members);
